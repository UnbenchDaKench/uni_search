<template>
  <div>
    ...
    <div v-else>
      <v-parallax dark src="https://i.ytimg.com/vi/mRMDkaozI2Q/maxresdefault.jpg">
        <v-row align="center" justify="center">
          <v-col class="text-center" cols="12">
            <h1 class="display-3 font-weight mb-4">Uni Search Now</h1>
            <h4 class="subheading display-1">High School to University Transition made easy!</h4>
          </v-col>
      ...
      <v-row align="center" justify="center">
        <v-col class="text-center" cols="12">
          <span class="font-weight mb-4">Based on Top rated schools</span>
        </v-col>
      </v-row>
      <v-divider></v-divider>
    ...
    <v-layout row wrap>
      <v-flex
        ...
        xs12
        lg6
        class="center ma-5 pa-5"
        v-if="resultArray.length< 1 && school.length > 2"
      >
